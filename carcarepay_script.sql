...
USER_PWD VARCHAR2(20) CONSTRAINT U_PWD_NN NOT NULL,
...
USER_LEVEL VARCHAR2(20) CONSTRAINT U_LEV_NN NOT NULL,
...
INSERT INTO MEMBER
VALUES(SEQ_MEM.NEXTVAL,'dejota827','1234','동재짱','없음ㅋ','010-2784-3845','시그니엘','다이아몬드',DEFAULT,999999999,DEFAULT,DEFAULT);

INSERT INTO MEMBER
VALUES(SEQ_MEM.NEXTVAL,'admin','1234','운영자','admin@gmail.com','010-1234-5678','서울','운영자',DEFAULT,0,DEFAULT,DEFAULT);

INSERT INTO MEMBER
VALUES(SEQ_MEM.NEXTVAL,'user01','1234','차은우','user01@gmail.com','010-1111-2222','서울','실버',DEFAULT,10000,DEFAULT,DEFAULT);

INSERT INTO MEMBER
VALUES(SEQ_MEM.NEXTVAL,'user02','1234','주지훈','user02@gmail.com','010-1111-2223','부산','골드',DEFAULT,4000,DEFAULT,DEFAULT);

INSERT INTO MEMBER
VALUES(SEQ_MEM.NEXTVAL,'user03','5555','공유','user03@gmail.com','010-5678-1234','대구','브론즈',DEFAULT,10000,'N',DEFAULT);

INSERT INTO MEMBER
VALUES(SEQ_MEM.NEXTVAL,'user04','3333','김봉식','user04@gmail.com','010-3333-3333','부산','브론즈',DEFAULT,10000,DEFAULT,DEFAULT);

INSERT INTO MEMBER
VALUES(SEQ_MEM.NEXTVAL,'user05','1234','홍길동','user07@gmail.com','010-1111-2332','서울','실버',DEFAULT,10000,DEFAULT,DEFAULT);

INSERT INTO MEMBER
VALUES(SEQ_MEM.NEXTVAL,'dg92','1234','양동건','dg92@gmail.com','010-9292-9292','인천','플래티넘',DEFAULT,1000000,DEFAULT,DEFAULT);

INSERT INTO MEMBER
VALUES(SEQ_MEM.NEXTVAL,'corncho','1234','윤상연','female@gmail.com','010-0000-0000','천호동','브론즈',DEFAULT,9999999,DEFAULT,DEFAULT);

INSERT INTO MEMBER
VALUES(SEQ_MEM.NEXTVAL,'messi96','1234','이한기','messi96@gmail.com','010-1234-1253','정자동','실버',DEFAULT,50,'Y',DEFAULT);

INSERT INTO MEMBER
VALUES(SEQ_MEM.NEXTVAL,'mgpark98','12345','박민규','mgpark98@gmail.com','010-3333-4444','평내호평','골드',DEFAULT,1000,'Y',DEFAULT);

INSERT INTO MEMBER
VALUES(SEQ_MEM.NEXTVAL,'sangyong96','1234','이상용','sangyong96@gmail.com','010-9999-9999','동해','골드',DEFAULT,9500,DEFAULT,DEFAULT);

INSERT INTO MEMBER
VALUES(SEQ_MEM.NEXTVAL,'jmpark','5555','박지민','jmpark@gmail.com','010-5555-5555','안양','플래티넘',DEFAULT,100000,DEFAULT,DEFAULT);

INSERT INTO MEMBER
VALUES(SEQ_MEM.NEXTVAL,'hasu98','1234','이종민','hasu98@gmail.com','010-4443-8989','갈매','브론즈',DEFAULT,20,'Y',DEFAULT);

INSERT INTO MEMBER
VALUES(SEQ_MEM.NEXTVAL,'seokwha92','1234','윤석화','seokwha92@gmail.com','010-5555-6666','동탄','골드',DEFAULT,5000,DEFAULT,DEFAULT);
